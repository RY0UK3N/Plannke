...
const workflowPath = path.join(root, '.github', 'workflows', 'bind-data-reset-v2-once.yml');
...
html = replaceExact(
  html,
  `<button class="btn btn-sm btn-outline-danger rounded-pill px-3" data-plannke-onclick="confirmClearData()">`,
  `<button class="btn btn-sm btn-outline-danger rounded-pill px-3" id="settings-clear-data">`,
...
console.log('Bound data reset explicitly on current main.');
